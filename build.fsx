...
let project = "ScribbleCodeGen"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "Generate F# Files from Scribble output"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Generate F# Files from Scribble Protocols"

// List of author names (for NuGet package)
let author = "Fangyi Zhou"

// Tags for your project (for NuGet package)
let tags = ""

// File system information
let solutionFile  = "ScribbleCodeGen.sln"
...
let gitOwner = "fangyi-zhou"
let gitHome = sprintf "%s/%s" "https://github.com" gitOwner

// The name of the project on GitHub
let gitName = "ScribbleCodeGen"

// The url for the raw files hosted
let gitRaw = Environment.environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/fangyi-zhou"

let website = "/ScribbleCodeGen"
...
let info =
  [ "project-name", "ScribbleCodeGen"
    "project-author", "Fangyi Zhou"
    "project-summary", "Generate F# Files from Scribble output"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/ScribbleCodeGen" ]
